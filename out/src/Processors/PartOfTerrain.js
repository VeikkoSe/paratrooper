var PartOfTerrain = function PartOfTerrain() {
  "use strict";
  $traceurRuntime.defaultSuperCall(this, $PartOfTerrain.prototype, arguments);
};
var $PartOfTerrain = PartOfTerrain;
($traceurRuntime.createClass)(PartOfTerrain, {draw: function() {
    "use strict";
    var foundMeshEntities = em.getAllEntitiesPosessingComponent("TerrainComponent");
